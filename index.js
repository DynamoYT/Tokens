...
/*
bo1.login(config.token2)
bot2.login(config.token3)
bot3.login(config.token4)
bot4.login(config.token5)
bot5.login(config.token6)
bot6.login(config.token7)
bot7.login(config.token8)
bot8.login(config.token9)
bot9.login(config.token10)
bot10.login(config.token11)
bot11.login(config.token12)
bot12.login(config.token13)
bot13.login(config.token14)
bot14.login(config.token15)
bot15.login(config.token16)
bot16.login(config.token17)
bot17.login(config.token18)
bot18.login(config.token19)
bot19.login(config.token20)
*/
